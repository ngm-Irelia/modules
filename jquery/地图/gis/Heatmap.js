...
(function() {
    ...
    HeatmapOverlay.prototype.setDataSet = function(data) {
        ...
        for(var i=0;i<points.length;i++) {
            ...
            //自定义覆盖物
            var myIcon = new BMap.Icon("/image/gis/opacity.svg", new BMap.Size(40,40), {
            ...
            marker.hotPoint = hotPoint;
            marker.attrMarker = points[i].marker;
            marker.addEventListener("click",function (e) {
                d3.selectAll("#hot-point-div").remove();//删除热力图点信息框
                var cmark = this;
                var content = '<div id="hot-point-div" class="hot-point-div">'+
                        '<div class="hot-content-div">'+
                        '</div>'+
                    '</div>';

                var label = new BMap.Label(content,{offset:new BMap.Size(20, 0)});
                label.setStyle({backgroundColor: "rgba(0,0,0,0)",border:"#1E262F"});
                cmark.setLabel(label);
                var hotDatas = [
                    {
                        "id":'2a0d80df-f9e8-4ddd-81f2-49a4905f3bb8',
                        "name":'刘东'
                    },{
                        "id":'04cd9ec0-06e8-45ab-b87b-3f686e754647',
                        "name":'王东'
                    },{
                        "id":'9b9f2d15-b867-42e8-9721-7c054e9b0fa5',
                        "name":'张立'
                    },{
                        "id":'fde931a0-28b2-4d68-b715-a49969c0e542',
                        "name":'董散'
                    },{
                        "id":'3654f4a4-21ad-467d-9cb6-8732aeb8a4e7',
                        "name":'李三强'
                    },{
                        "id":'57a3a2cd-6c56-449d-a6d6-5d2802fadbde',
                        "name":'露露'
                    },{
                        "id":'5b3ee181-4fbb-47fa-8628-17915339dbb8',
                        "name":'王蕊'
                    },{
                        "id":'412a5a94-903c-4de0-bc19-154490f1c28d',
                        "name":'江山'
                    },{
                        "id":'c1916704-6781-49cb-99c7-5883492d9ad2',
                        "name":'李四立'
                    },{
                        "id":'643d4d8c-854d-4d60-820d-3051bb898fe6',
                        "name":'王珊珊'
                    },{
                        "id":'a57350b1-d4f4-43d8-8efa-4de2e70ddd16',
                        "name":'朱瑞'
                    }
                            ];
                var hotTR = "";
                for(var i=0;i<hotDatas.length;i++){
                    hotTR += "<tr class='hot-msg'><td>员工号:</td><td>2001</td><td>姓名:</td>"+
                        "<td id='"+ hotDatas[i].id +"' name='"+hotDatas[i].name+"' class='hot-detail' >"+ hotDatas[i].name +"</td></tr>";
                }
                $(".hot-content-div").html(hotTR);
                $(".hot-detail").unbind().bind("click",function(evt){
                    console.log(this)
                    var hotName = $(this).attr("name");
                    var hotId = $(this).attr("id");
                    console.log(hotName)
                    console.log(hotId)
                    //location.href = '/entity?id=' + config.nodeArray[0] + '&type=PERSON';
    ...
    HeatmapOverlay.prototype.addDataPoint = function(lng, lat, count) {
        ...
        this.heatmap.store.addDataPoint(point.x, point.y, count);// 设置了地点
        this.latlngs.push({
            latlng: latlng,
            c: count
        });
