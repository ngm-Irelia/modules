(function () {
    ...
    function load() {
        ...
        if (!inArray(excludes, 'ol')) {
            inputCSS("/js/public/supermap/ol.css");//http://cdn.bootcss.com/openlayers/4.2.0/ol.css
            inputScript("/js/public/supermap/ol.js");//http://cdn.bootcss.com/openlayers/4.2.0/ol.js
        }
        ...
        if (!inArray(excludes, 'iclient9-openlayers')) {
            inputScript("/js/public/supermap/dist/iclient9-openlayers.min.js");
        }
        if (!inArray(excludes, 'iclient9-openlayers-css')) {
            inputCSS("/js/public/supermap/dist/iclient9-openlayers.min.css");
        }
