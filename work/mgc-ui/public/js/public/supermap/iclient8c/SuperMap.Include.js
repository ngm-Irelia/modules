(function() {
    ...
    function inputCSS(style){
        var css = '<' + 'link rel="stylesheet" href="/js/public/supermap/theme/default/' + style + '"' + '><' + '/>';

        document.writeln(css);
    }
    //加载类库资源文件
    function loadSMLibs() {
        inputScript('/js/public/supermap/iclient8c/SuperMap-8.1.1-15521.js');
        inputScript('/js/public/supermap/iclient8c/SuperMap_Plot-8.1.1-15521.js');
        loadLocalization();
        inputCSS('style.css');
        inputCSS('google.css');
    }
